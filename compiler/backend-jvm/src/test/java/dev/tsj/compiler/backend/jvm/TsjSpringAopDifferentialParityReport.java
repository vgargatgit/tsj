...
/**
 * TSJ-35c differential parity report model for transactional/AOP subset.
 */
record TsjSpringAopDifferentialParityReport(
        List<ScenarioResult> scenarios,
        Path reportPath,
        Path moduleReportPath
) {
    TsjSpringAopDifferentialParityReport {
    ...
    String toJson() {
        ...
        builder.append("{\"suite\":\"TSJ-35c-aop-differential-parity\",\"scenarios\":[");
