...
/**
 * TSJ-35b booted runtime conformance report model.
 */
record TsjSpringAopRuntimeConformanceReport(
        List<ScenarioResult> scenarios,
        Path reportPath,
        Path moduleReportPath
) {
    TsjSpringAopRuntimeConformanceReport {
    ...
    String toJson() {
        ...
        builder.append("{\"suite\":\"TSJ-35b-aop-runtime-conformance\",\"scenarios\":[");
        for (int index = 0; index < scenarios.size(); index++) {
            ...
            builder.append("{\"scenario\":\"")
                    ...
                    .append("\",\"beginCount\":")
                    .append(scenario.beginCount())
                    .append(",\"commitCount\":")
                    .append(scenario.commitCount())
                    .append(",\"rollbackCount\":")
                    .append(scenario.rollbackCount())
                    .append(",\"notes\":\"")
