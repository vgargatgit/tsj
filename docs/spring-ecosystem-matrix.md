...
|---|---|---|---|---|
| web | `spring-boot-starter-web` | Supported (subset) | `tests/spring-matrix/tsj37-web-supported/main.ts` | Differential parity check compares TS-authored controller behavior with Java reference controller behavior. |
